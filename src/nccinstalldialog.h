...
#ifndef NCCINSTALLDIALOG_H
#define NCCINSTALLDIALOG_H

#include <QDialog>
#include <guessedvalue.h>

namespace Ui {
    class NccInstallDialog;
}
 ...
 **/
class NccInstallDialog : public QDialog
{
    Q_OBJECT
...
public:
  ...
  **/
 explicit NccInstallDialog(const MOBase::GuessedValue<QString> &preset, QWidget *parent = 0);
  ~NccInstallDialog();
...
private:
  Ui::NccInstallDialog *ui;
  bool m_Manual;
};

#endif // NCCINSTALLDIALOG_H
